...
plot.true
# save the plot
ggsave("q3-fix-the-parameter.png", plot.true, width = 8.27, height = 11.69, units = "in")
```
...
```{r}
fit.mis.alpha$plot <- fit.mis.alpha$plot + labs(subtitle = "True alpha = 2.439, Mis-specified alpha = 3.0")
```
...
fit.mis.K$plot <- fit.mis.K$plot + labs(subtitle = "True K = 0.136, Mis-specified K = 0.3")
```
...
plot.mis
# save the plot
ggsave("q3-mis-specify-the-parameter.png", plot.mis, width = 11.69, height = 8.27, units = "in")
```