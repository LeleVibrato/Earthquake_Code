...
# add a column to the synthetic catalogue data to indicate the
# generation of the event gen = 1 for background events and gen > 1 for
# triggered events and other events
